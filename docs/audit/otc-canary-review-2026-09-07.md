...
The assembled candidate at `090453df4ab9e21dd9a78bb7d0949ab147cc5b1c` passed the six-flow canary rehearsal after the nonce-agreement, signing-cutoff and required-persistence fixes. Its production build passed; the pre-existing PWA/glob warning remains outside this feature and offline use is not claimed. Policy injection was restricted to the disposable rehearsal checkout.
