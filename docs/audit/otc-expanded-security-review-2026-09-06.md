...
- Follow-up on 2026-09-07: [PR #1309](https://github.com/ophis-fi/ophis/pull/1309) replaced only `dispatchStorageChange()` with a plain `Event` plus defined storage properties. The regression behavior is preserved and the CodeQL extern-model warning is resolved.
