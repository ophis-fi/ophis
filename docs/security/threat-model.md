...
| **T**ampering | 2-of-3 consensus collusion (2 hostile upstreams) | Low (requires owning 2 distinct CDN/operator) | Critical | Distinct failure domains chosen (publicnode/tenderly/1rpc); failure-domain table in erpc.yaml.tmpl honestly documents 2-of-3 share CF DNS as DoS-not-poisoning residual. |
