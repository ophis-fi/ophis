...
- [x] Final local verification: 48 suites / 379 tests pass, one optional network test skipped; typecheck, scoped lint and production build pass; six canary-mode browser flows pass on local Anvil. Semgrep: 125 rules / 44 files, zero findings. See `../../audit/otc-canary-review-2026-09-07.md` for findings, limitations and evidence.
