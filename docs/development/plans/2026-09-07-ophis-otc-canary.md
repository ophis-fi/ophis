...
- [x] Scoped security review and fresh review of implementation slices #1311–#1321, each within 400 changed lines. The final operations release is subject to the same gate.
