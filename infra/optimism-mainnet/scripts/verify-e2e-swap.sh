...
#
# Run from infra/optimism-mainnet/ — the docker compose paths are relative.
#
...
SETTLEMENT_ADDR="0x310784c7FCE12d578dA6f53460777bAc9718B859"
DRIVER_EOA="0x92B9bE5e96795E8630fDC61efb0e705E75b1A1B1"
PARTNER_FEE_SAFE="0x858f0F5eE954846D47155F5203c04aF1819eCeF8"
...
Env:
  OPHIS_RPC           override RPC endpoint (default: local eRPC at :4001)
EOF
  exit 3
}
