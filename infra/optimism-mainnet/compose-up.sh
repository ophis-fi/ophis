...
CONFIG_BOUND_SERVICES=(rpc-proxy driver orderbook autopilot okx-solver enso-solver lifi-solver openocean-solver dodo-solver curve-solver woofi-solver uniswap-v4-solver velodrome-solver velodrome-slipstream-solver)
if docker compose ps --services 2>/dev/null | grep -qF rpc-proxy; then
  ...
  DOWNSTREAM=(driver orderbook autopilot okx-solver enso-solver lifi-solver openocean-solver dodo-solver curve-solver woofi-solver uniswap-v4-solver velodrome-solver velodrome-slipstream-solver)
