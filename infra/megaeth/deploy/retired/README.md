...
Retired 2026-05-12 as part of Spec 3 finalization. The original plan was to seed a Greg-deployed UniswapV2 pool with WETH + USDT0 on MegaETH mainnet to bootstrap day-1 liquidity. Spec 3 switched to routing through Kumbaya (MegaETH's dominant UniswapV3-fork DEX, ~$53M TVL) instead, removing the need to provide our own liquidity.
