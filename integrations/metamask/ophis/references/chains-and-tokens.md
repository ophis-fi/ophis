...
Ophis is **same-chain best execution** (MEV-protected CoW batch settlement). For cross-chain bridging, use `mm swap --to-chain` or a bridging skill.

## Chains

| Chain | ID | Orderbook base URL | Settlement (EIP-712 verifyingContract) | VaultRelayer (approve) | Model | mm-supported? |
|---|---|---|---|---|---|---|
...
| Plasma | 9745 | `https://api.cow.fi/plasma` | `0x9008D19f58AAbD9eD0D60971565AA8510560ab41` | `0xC92E8bdf79f0507f65a392b0ab4667716BFE0110` | CoW-hosted | ✅ (EIP-155) |
...
> Always verify a token address on-chain before swapping. For chains/tokens not listed, resolve the ERC-20 address (e.g. via a block explorer or another MetaMask skill) and pass it with its decimals.
