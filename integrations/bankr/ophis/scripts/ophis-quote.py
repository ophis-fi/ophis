...
def main() -> None:
    ...
    # Zero address as `from` is fine for a price-only quote.
    quote = oc.get_quote(
        chain_id, sell_token, buy_token, sell_wei,
        "0x0000000000000000000000000000000000000000", full_app_data, app_hash,
    )
