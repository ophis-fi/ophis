...
- `../../rewards_fizz_data/`: extracted ABI inventory, entry-point selection, protocol-understanding notes, corpora, logs, and coverage outputs
...
```bash
FOUNDRY_PROFILE=rewards-fuzz forge build
FOUNDRY_PROFILE=rewards-fuzz forge test --match-contract FoundryTester
FOUNDRY_PROFILE=rewards-fuzz echidna . --contract FuzzTester --config echidna.yaml
