...
contract FablesTest is Test {
    ...
    OphisFablesAdapter private adapter;
    bool private forkEnabled;

    function setUp() external {
        string memory rpcUrl = vm.envString("ROBINHOOD_RPC");
        forkEnabled = true;
        vm.createSelectFork(rpcUrl);
        adapter = new OphisFablesAdapter(address(this), POOL_MANAGER, WETH, USDG);
    }
    ...
    function testOnlySettlementCanSwap() external {
        ...
        vm.expectRevert(OphisFablesAdapter.Unauthorized.selector);
