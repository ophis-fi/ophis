...
export const faqLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: "Via the CoW Protocol CIP-75 priceImprovementBps field in the order's appData, taken from the trade output at settlement.",
      },
    },
    {
      '@type': 'Question',
...
ordinary trades, with 25% of any price improvement when a solver beats your
quote, capped at 0.5% of the trade. Your principal is never touched.
...
`appData`, taken from the trade output at settlement. Full detail on the
