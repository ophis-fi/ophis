...
| **Fee model** | 0% on ordinary trades; 25% of price improvement, capped at 0.5% of volume; never your principal | ~50% of surplus / quote improvement, capped near 1% of volume, plus a small volume fee on some orders | ~0.1% (10 bps) on most swaps (Matcha Standard), varies by chain and route | 0.15% (15 bps) interface fee on most swaps; 50/50 positive-slippage split |
...
[Velora UI fees](https://help.paraswap.xyz/en/articles/6554779-paraswap-ui-fees).
