...
export const Color = {
  ...
  // Explorer Colors
  explorer_red1: '#b42332',
  explorer_red4: '#d83265',
  explorer_green1: '#217346',
  explorer_green2: '#09371d',
  explorer_green3: '#a9ffcd',
  explorer_yellow4: '#f6c343',
  explorer_blue1: '#315ca8',
  explorer_orange1: '#5d2a1a',
  explorer_textPrimary: '#17191c',
  explorer_bg: '#ffffff',
  explorer_bg2: '#f2f2f3',
  explorer_background: '#fafafb',
  explorer_bgWrapper: '#ffffff',
  explorer_bgActionCards: '#eaf4ed',
  explorer_bgHighlighted: '#fbe1d1',
  explorer_bgSelected: '#d9d9d9',
  explorer_bgSelectedDarker: '#b6b6b6',
  explorer_bgSelectedDark: '#e8e8ea',
  explorer_bgProgress: '#5d2a1a',
  explorer_bgInput: '#f2f2f3',
  explorer_bgInputLighter: '#e8e8ea',
  explorer_bgRowHover: '#fafafb',
  explorer_bgButtonHover: '#34373b',
  explorer_bgButtonDisabled: '#e8e8ea',
  explorer_bgBanner: '#fbe1d1',
  explorer_bgDeleteOrders: '#fbe9e7',
  explorer_bgDisabled: '#e8e8ea',
  explorer_bgOpaque: '#f2f2f3',
  explorer_bgLighter: '#f7f7f7',
  explorer_paperCustom: '#ffffff',
  explorer_shade: '#f2f2f3',
  explorer_textSecondary1: '#34373b',
  explorer_textSecondary2: '#5b5f68',
  explorer_textSecondary: '#5b5f68',
  explorer_textActive: '#5d2a1a',
  explorer_textButtonHover: '#e9e9f0',
  explorer_textBanner: '#5d2a1a',
  explorer_textDeleteOrders: '#912f26',
  explorer_textError: '#cd3636',
  explorer_textDisabled: '#6e737d',
  explorer_networkBackground: '#f2f2f3',
  explorer_networkText: '#34373b',
  explorer_border: '#e8e8ea',
  explorer_borderPrimary: '#6e737d',
  explorer_tableRowBorder: '#e8e8ea',
  explorer_boxShadow: 'rgba(23, 25, 28, 0.06)',
  explorer_buttonPrimary: '#e8e6e3',
  explorer_buttonSuccess: '#217346',
  explorer_buttonDisabled: '#3d4043',
  explorer_buttonDanger: '#b42332',
  explorer_buttonSecondary: '#696969',
  explorer_buttonWarning: '#a13b1f',
  explorer_labelBgOpen: '#9797B84D',
  explorer_gradient1: '#ffffff',
  explorer_gradient2: '#ffffff',
  explorer_shadow: '#00000047',
  explorer_grey: '#5b5f68',
  explorer_greyShade: '#5b5f68',
  explorer_greyOpacity: '#f2f2f3',
  explorer_greenOpacity: '#eaf4ed',
  explorer_orangeOpacity: '#fbe1d1',
  ...
  yellow300Primary: '#F2CD16',
  yellow700Primary: '#AE8D0B',
  yellow800Primary: '#745905',
...
const COLOR_MAPPINGS = {
  ...
  // Yellow primary color mappings
  yellow300Primary: { light: 'yellow300Primary', dark: 'yellow300Primary' },
  yellow700Primary: { light: 'yellow700Primary', dark: 'yellow700Primary' },
  yellow800Primary: { light: 'yellow800Primary', dark: 'yellow800Primary' },
} as const
...
export type ThemeColors = {
  ...
  blue700Primary: string
  blue900Primary: string
  yellow300Primary: string
  yellow700Primary: string
  yellow800Primary: string
