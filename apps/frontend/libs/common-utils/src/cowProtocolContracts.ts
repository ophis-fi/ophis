import {
  ...
  ARC_SETTLEMENT,
  ARC_VAULT_RELAYER,
  OLD_BARN_ETH_FLOW_ADDRESS,
  STAGING_MIGRATED_CONTRACT_NETWORKS,
...
export const COW_PROTOCOL_SETTLEMENT_CONTRACT_ADDRESS: AddressPerChain = {
  ...
  ...(ARC_ENABLED && ARC_SETTLEMENT ? { [ARC_CHAIN_ID]: ARC_SETTLEMENT } : {}),
...
export const COW_PROTOCOL_VAULT_RELAYER_ADDRESS: AddressPerChain = {
  ...
  ...(ARC_ENABLED && ARC_VAULT_RELAYER ? { [ARC_CHAIN_ID]: ARC_VAULT_RELAYER } : {}),
