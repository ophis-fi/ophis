...
export const hookDappsRegistry = {
  ...
  CLAIM_COW_AIRDROP: {
    ...
    description: `Effortless Airdrop Claims! The Claim COW Airdrop feature simplifies the process of collecting free COW tokens before or after your swap, seamlessly integrating into the Ophis platform. Whether you're claiming new airdrops or exploring Ophis on a new network, this tool ensures you get your rewards quickly and easily.`,
    image:
  ...
  COW_AMM_DEPOSIT: {
    name: `AMM Deposit`,
    type: 'IFRAME',
    descriptionShort: `Add liquidity to any of the AMM pools`,
  ...
  'cow-sdk://flashloans/aave/v3/collateral-swap': {
    ...
    description: `The swap adapter contracts integrate Aave Flash Loans and Ophis to facilitate advanced actions like swapping collateral assets when there are borrow positions. Learn more at https://aave.com/docs/developers/smart-contracts/swap-features.`,
    version: '0.0.1',
  ...
  'cow-sdk://flashloans/aave/v3/debt-swap': {
    ...
    description: `The swap adapter contracts integrate Aave Flash Loans and Ophis to facilitate advanced actions like swapping debt assets. Learn more at https://aave.com/docs/developers/smart-contracts/swap-features.`,
    version: '0.0.1',
    website: 'https://aave.com',
    image: 'https://files.cow.fi/token-lists/images/1/0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9/logo.png',
  },
  'cow-sdk://flashloans/aave/v3/repay-with-collateral': {
    ...
    description: `The swap adapter contracts integrate Aave Flash Loans and Ophis to facilitate advanced actions like repaying borrow positions using collateral. Learn more at https://aave.com/docs/developers/smart-contracts/swap-features.`,
    version: '0.0.1',
    website: 'https://aave.com',
    image: 'https://files.cow.fi/token-lists/images/1/0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9/logo.png',
  },
