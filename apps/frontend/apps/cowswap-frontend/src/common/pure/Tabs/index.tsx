...
// Ophis/Nucleus: active tab uses brand (coral) instead of CoW info-blue, bold weight, brand underline.
export const Tab = styled.button<{ $active: boolean }>`
  ...
  padding: var(--ophis-space-3, 12px) var(--ophis-space-4, 16px);
  ...
  border-radius: var(--ophis-radius-sm, 4px);
  flex: 1 1 auto;
