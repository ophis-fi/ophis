 ...
 * A/B ship with all of them unreachable; enabling any requires a new
 * milestone, security review, and explicit owner approval. The contract also
 * has a payable receive() — empty-calldata sends are equally out of scope.
 */
