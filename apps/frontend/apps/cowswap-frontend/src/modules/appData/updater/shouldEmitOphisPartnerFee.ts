 ...
 * disburses 75% weekly); Ophis-operated chains settle on our
 ...
 * only the sovereign deployment set. That cut canonical-chain revenue (confirmed over-
...
export function shouldEmitOphisPartnerFee(chainId: number | undefined): boolean {
  ...
  // chains plus the Ophis-operated set. Chains absent from the map (i.e.
