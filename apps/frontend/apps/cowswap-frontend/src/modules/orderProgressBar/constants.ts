...
export const COW_SWAP_BENEFITS = [
  ...
  msg`Ophis is the only exchange that matches peer-to-peer order matching: peer-to-peer swaps that save on settlement costs.`,
  ...
  msg`Liquidity pools on AMM pools grow faster than on other AMMs because they don't lose money to arbitrage bots.`,
