...
**surplus**. On every supported chain, Ophis retains 80% of
...
CoW Protocol additionally applies its upstream improvement policy and protocol fee for a fixed cost
