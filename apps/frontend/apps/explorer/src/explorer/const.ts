...
export const DOCS_LINK = 'https://docs.ophis.fi'
export const PROTOCOL_LINK = 'https://ophis.fi'
export const COWSWAP_LINK = 'https://swap.ophis.fi'
export const CONTRACTS_CODE_LINK = 'https://github.com/cowprotocol/contracts'
export const DISCORD_LINK = 'https://swap.ophis.fi/#/contact'
export const DUNE_DASHBOARD_LINK = 'https://dune.com/cowprotocol/cowswap'
export const TWITTER_LINK = 'https://x.com/ophis_fi'
...
export const APP_TITLE = 'Ophis Explorer'
